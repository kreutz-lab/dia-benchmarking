...
DIANN_results <- read.csv("Skyline_msfragger_msstats.csv", na.strings = "#N/A")  %>% filter(!grepl("precursor", Fragment.Ion))
...
saveRDS(output$ProteinLevelData, "msfragger_noNorm_noImpu2.rda")
